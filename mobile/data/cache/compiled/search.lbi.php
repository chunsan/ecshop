<div class="search" style="display:none;">
    ...
    <header class="ect-header ect-margin-tb text-center" style="top:0;"><span><?php echo $this->_var['lang']['search']; ?></span><a href="javascript:;" onClick="closeSearch();"><i class="icon-close pull-right"></i></a></header>
